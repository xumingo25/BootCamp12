...
public class RegistroYoutube {
    ...
    void test(){
        ...
        By botonAccederXpath = By.xpath("//*[@id='buttons']/ytd-button-renderer/yt-button-shape/a/yt-touch-feedback-shape/div/div[2]");
        WebElement botonAccederVisible = wait.until(ExpectedConditions.visibilityOfElementLocated(botonAccederXpath));
        WebElement botonAcceder = driver.findElement(By.xpath("//*[@id='buttons']/ytd-button-renderer/yt-button-shape/a/yt-touch-feedback-shape/div/div[2]"));
        botonAcceder.click();
